  ...
  useLayoutEffect(() => {
    ...
    if (window && typeof window.innerWidth !== null) {
      ...
      ScrollTrigger.create({
        ...
        start: isMobile ? "top+=400px" : "top+=200px top",
    ...
    <>
      <section
        ...
        <p className="text-center text-lg md:max-w-[80%]">
          ...
          competition. It&apos;s ready to battle for conversions, but is it
          fully equipped to conquer the challenge? That&apos;s where our
          AI-powered roasting comes in, serving as your landing page&apos;s
          personal trainer and strategist.
          <br />
          <br />A roast isn&apos;t just an evaluation; it&apos;s a
          metamorphosis, a transformation that turns your landing page into a
          conversion champion. Our team of experts, armed with cutting-edge AI
          tools, will scrutinize every aspect of your page, from its design and
          copywriting to its user experience.
        </p>
          ...
          <div
            ...
            <div className="bg-white custom-shadow text-black py-3 px-4 rounded-md w-[80vw] md:min-w-[30vw] md:w-[30vw] flex flex-col gap-3">
              ...
              <p className="text-xs">
                ...
                conversion victory, guiding you through the steps to optimize
            ...
            <div className="bg-white custom-shadow text-black py-3 px-4 rounded-md w-[80vw] md:min-w-[30vw] md:w-[30vw] flex flex-col gap-3">
              ...
              <p className="text-xs">
                Every landing page is unique, just like every gladiator has
                their own fighting style. Our AI algorithms recognize this
                uniqueness, tailoring their recommendations to your specific
            ...
            <div className="bg-white custom-shadow text-black py-3 px-4 rounded-md w-[80vw] md:min-w-[30vw] md:w-[30vw] flex flex-col gap-3">
              ...
              <p className="text-xs">
                ...
                the digital arena. Our AI-powered roasting is designed to help
                you achieve your conversion goals, maximizing your ROI and
        ...
        <div className="flex flex-col gap-3 md:max-w-[60%] items-center justify-center">
          ...
          <p className="text-center">
            Embark on your journey to conversion mastery with our AI-powered
            roast today. Our experts will analyze your landing page, provide
            personalized insights, and help you transform your page into a
            conversion champion.
          </p>
          <Link
            href="/roast"
            className="relative w-fit group before:absolute before:bg-white before:bottom-0 before:left-0 before:h-full before:w-full before:origin-bottom hover:before:scale-y-[0.35] before:scale-y-100 px-4 pt-2 pb-3 before:transition-transform before:ease-in-out before:duration-500 hover:text-white text-black">
